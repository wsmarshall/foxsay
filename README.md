A take on the original 'Cowsay' (written in Perl at first). A seemingly useless CLI program, still popular today among Unix server admins. Constructed for didactic purposes.
